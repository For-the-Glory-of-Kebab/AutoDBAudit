...
from autodbaudit.application.actions.action_detector import detect_all_actions, consolidate_actions
...
class SyncService:
    ...
    def sync(
        ...
        if input_excel and input_excel.exists():
            ...
            from autodbaudit.application.actions.action_detector import create_exception_action
            ...
            for ex in raw_exceptions:
                ...
                exception_changes.append(create_exception_action(
        ...
        valid_keys = {f"{s.hostname}|{i.instance_name or ''}".lower() for s, i in valid_pairs}
