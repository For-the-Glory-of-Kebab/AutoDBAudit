...
even invoking .exe files like pytest and python directly from ./venv/ or using 2>&1 at the end of the powershell commands causes this issue so you should use the "activate" script in your sessions and do the commands with python and pytest directly. this all should ofcourse be wrapped.